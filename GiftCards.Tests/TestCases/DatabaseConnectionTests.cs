  ...
  public  class DatabaseConnectionTests
    {
        ...
        public void MongoBookDBContext_Constructor_Success()
        {
            ...
            File.AppendAllText("../../../../output_databaseConnection_revised.txt", "MongoBookDBContext_Constructor_Success=" + res + "\n");
        ...
        public void MongoBookDBContext_GetCollection_ValidName_Success()
        {
            ...
            //writing tset boolean output in text file, that is present in project directory
            File.AppendAllText("../../../../output_databaseConnection_revised.txt", "MongoBookDBContext_GetCollection_ValidName_Success=" + res + "\n");
